            ...
            <div class="row align-items-center">
                <div class="col-xl-6 col-md-6">
                    <div class="about_e_details">
                        <h3>Sobre nós</h3>
                        <p>Nós do My Anonymous Friend, somos uma equipe de jovens desenvolvedores que decidiram criar um espaço onde pessoas possam conversar com tranquilidade, em completo anonimato e até com ajuda profissional! </p>
                        <div class="download_cv">
                            <a class="boxed-btn3" href="#">comece a conversar agora</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-6 col-md-6">
                        ...
                        <div class="testmonial_active owl-carousel">
                            <div class="single_carousel">
                                    <div class="single_testmonial text-center">
                                            ...
                                            <p>Sempre tive ansiedade para conversar com pessoas.  <br>
                                                      Com a ajuda profissional no My Anonymous Friend já estou bem melhor!<br>
                                                    </p>
                            ...
                            <div class="single_carousel">
                                    <div class="single_testmonial text-center">
                                            ...
                                            <p>O peso da responsabilidade na internet onde tudo fica salvo para sempre <br>
                                                    nunca permitiu que eu me abrisse para ninguém.  <br>
                                                    Com o My Anonymous Friend, agora isso é possível. </p>
                                            <div class="testmonial_author">
                                                <div class="thumb">
                                                        <img src="img/testmonial/thumb.png" alt="">
                                                </div>
